    ...
    <header className="max-w-screen-xl mx-auto p-4 flex justify-between items-center font-bold">
      <Link to="/">
        <div className="flex items-center">
          {/* <AiFillApple size={28} /> */}
          <img
            className="flex text-xl w-10 h-10 rounded-xl"
            src="images/Bears.png"
            alt=""
          />
          <div className="ml-1 text-xl">Doosan Bears</div>
        </div>
      </Link>
      <div className="flex items-center">
        <ul className="flex text-gray-400 text-sm">
          <li className="ml-2">현재 순위 : 4위</li>
          <li className="ml-2">팀타율 : 0.249</li>
          <li className="ml-2">팀 출루율 : 0.330</li>
          <li className="ml-2">팀 장타율 : 0.365</li>
        </ul>
...
// const Header = ({ account, setAccount }) => {
//   const [coinPrice, setCoinPrice] = useEffect();
...
//         <div className="flex items-center">
//           <AiFillApple size={28} />
//           <div className="ml-1 text-xl">Apple</div>
//         </div>
//       </Link>
//       <div className="flex items-center">
//         {coinPrice && (
